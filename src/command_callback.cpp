...
DEF_CB_RES_TILE_TUPLE(BuildBridge, Commands::BuildBridge)
...
DEF_CB_RES_TILE_TUPLE(RoadDepot, Commands::BuildRoadDepot)
DEF_CB_RES_TILE_TUPLE(RailDepot, Commands::BuildRailDepot)
...
DEF_CB_RES_TUPLE(GiveMoney, Commands::GiveMoney)
DEF_CB_RES_TUPLE(CreateGroup, Commands::CreateGroup)
DEF_CB_RES(FoundRandomTown)
DEF_CB_RES_TILE_TUPLE(RoadStop, Commands::BuildRoadStop)
DEF_CB_RES_TUPLE(StartStopVehicle, Commands::StartStopVehicle)
DEF_CB_GENERAL(Game)
DEF_CB_RES(AddVehicleNewGroup)
DEF_CB_RES_TUPLE(CreateOrderList, Commands::CreateOrderList)
DEF_CB_RES_PAYLOAD(InsertOrder, Commands::InsertOrder)
DEF_CB_RES_TUPLE(InsertOrdersFromVehicle, Commands::InsertOrdersFromVeh)
DEF_CB_RES(AddPlan)
DEF_CB_RES_TUPLE(MoveStationName, Commands::MoveStationName)
DEF_CB_RES_TUPLE(MoveWaypointName, Commands::MoveWaypointName)
DEF_CB_RES(SetVirtualTrain)
DEF_CB_RES(VirtualTrainWagonsMoved)
DEF_CB_RES_TUPLE(DeleteVirtualTrain, Commands::SellVirtualVehicle)
DEF_CB_RES(AddVirtualEngine)
DEF_CB_RES(MoveNewVirtualEngine)
DEF_CB_RES_TUPLE(AddNewSchDispatchSchedule, Commands::SchDispatchAddNewSchedule)
DEF_CB_RES_TUPLE(SwapSchDispatchSchedules, Commands::SchDispatchSwapSchedules)
DEF_CB_RES_TUPLE(AdjustSchDispatch, Commands::SchDispatchAdjust)
