...
public:
	static inline const SaveLoad description[] = {
	   ...
	   SLE_CONDRING(Aircraft, path.td,                SLE_UINT8,                    SLV_MULTITILE_AIRPORTS, SL_MAX_VERSION),
	   SLE_CONDRING(Aircraft, path.tile,              SLE_UINT32,                   SLV_MULTITILE_AIRPORTS, SL_MAX_VERSION),
	};
